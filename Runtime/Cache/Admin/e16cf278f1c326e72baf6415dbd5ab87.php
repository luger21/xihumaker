...
<head>
    ...
    <link href="/xihu/Public/favicon.ico" type="image/x-icon" rel="shortcut icon">
    <link rel="stylesheet" type="text/css" href="/xihu/Public/Admin/css/base.css" media="all">
    <link rel="stylesheet" type="text/css" href="/xihu/Public/Admin/css/common.css" media="all">
    <link rel="stylesheet" type="text/css" href="/xihu/Public/Admin/css/module.css">
    <link rel="stylesheet" type="text/css" href="/xihu/Public/Admin/css/style.css" media="all">
	<link rel="stylesheet" type="text/css" href="/xihu/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css" media="all">
     <!--[if lt IE 9]>
    <script type="text/javascript" src="/xihu/Public/static/jquery-1.10.2.min.js"></script>
    <![endif]--><!--[if gte IE 9]><!-->
    <script type="text/javascript" src="/xihu/Public/static/jquery-2.0.3.min.js"></script>
    <script type="text/javascript" src="/xihu/Public/Admin/js/jquery.mousewheel.js"></script>
    <!--<![endif]-->
...
<script>
	...
	<script type="text/javascript" src="/xihu/Public/static/uploadify/jquery.uploadify.min.js"></script>
...
<div class="tab-wrap">
            ...
            <?php if(is_array($fields[$key])): $i = 0; $__LIST__ = $fields[$key];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$field): $mod = ($i % 2 );++$i; if($field['is_show'] == 1 || $field['is_show'] == 2): ?><div class="form-item cf">
                    ...
                    <div class="controls">
                        <?php switch($field["type"]): case "num": ?><input type="text" class="text input-mid" name="<?php echo ($field["name"]); ?>" value="<?php echo ($field["value"]); ?>"><?php break;?>
                            ...
                            <?php case "selectRelation": ?><select name="<?php echo ($field["name"]); ?>">
                                    <?php $_result=parse_relation_attr($field['extra']);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if(($field["value"]) == $key): ?>selected<?php endif; ?>><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select><?php break;?>
                            ...
                            <?php case "picture": ?><div class="controls">
								...
								$("#upload_picture_<?php echo ($field["name"]); ?>").uploadify({
							        "height"          : 30,
							        "swf"             : "/xihu/Public/static/uploadify/uploadify.swf",
    ...
    (function(){
        var ThinkPHP = window.Think = {
            "ROOT"   : "/xihu", //当前网站地址
            "APP"    : "/xihu/admin.php?s=", //当前项目地址
            "PUBLIC" : "/xihu/Public", //项目公共目录地址
    ...
    <script type="text/javascript" src="/xihu/Public/static/think.js"></script>
    <script type="text/javascript" src="/xihu/Public/Admin/js/common.js"></script>
    <script type="text/javascript">
        +function(){
...
<link href="/xihu/Public/static/datetimepicker/css/datetimepicker.css" rel="stylesheet" type="text/css">
<?php if(C('COLOR_STYLE')=='blue_color') echo '<link href="/xihu/Public/static/datetimepicker/css/datetimepicker_blue.css" rel="stylesheet" type="text/css">'; ?>
<link href="/xihu/Public/static/datetimepicker/css/dropdown.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="/xihu/Public/static/datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
<script type="text/javascript" src="/xihu/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
<script type="text/javascript">
