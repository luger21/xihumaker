...
<head>
    ...
    <link href="/xihumaker/Public/favicon.ico" type="image/x-icon" rel="shortcut icon">
    <link rel="stylesheet" type="text/css" href="/xihumaker/Public/Admin/css/base.css" media="all">
    <link rel="stylesheet" type="text/css" href="/xihumaker/Public/Admin/css/common.css" media="all">
    <link rel="stylesheet" type="text/css" href="/xihumaker/Public/Admin/css/module.css">
    <link rel="stylesheet" type="text/css" href="/xihumaker/Public/Admin/css/style.css" media="all">
	<link rel="stylesheet" type="text/css" href="/xihumaker/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css" media="all">
     <!--[if lt IE 9]>
    <script type="text/javascript" src="/xihumaker/Public/static/jquery-1.10.2.min.js"></script>
    <![endif]--><!--[if gte IE 9]><!-->
    <script type="text/javascript" src="/xihumaker/Public/static/jquery-2.0.3.min.js"></script>
    <script type="text/javascript" src="/xihumaker/Public/Admin/js/jquery.mousewheel.js"></script>
    <!--<![endif]-->
...
<script>
    ...
    (function(){
        var ThinkPHP = window.Think = {
            "ROOT"   : "/xihumaker", //当前网站地址
            "APP"    : "/xihumaker/index.php?s=", //当前项目地址
            "PUBLIC" : "/xihumaker/Public", //项目公共目录地址
    ...
    <script type="text/javascript" src="/xihumaker/Public/static/think.js"></script>
    <script type="text/javascript" src="/xihumaker/Public/Admin/js/common.js"></script>
    <script type="text/javascript">
        +function(){
...
<link href="/xihumaker/Public/static/datetimepicker/css/datetimepicker.css" rel="stylesheet" type="text/css">
<?php if(C('COLOR_STYLE')=='blue_color') echo '<link href="/xihumaker/Public/static/datetimepicker/css/datetimepicker_blue.css" rel="stylesheet" type="text/css">'; ?>
<link href="/xihumaker/Public/static/datetimepicker/css/dropdown.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="/xihumaker/Public/static/datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
<script type="text/javascript" src="/xihumaker/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
<script type="text/javascript">
$(function(){
	//搜索功能
